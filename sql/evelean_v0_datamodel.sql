...
CREATE TABLE IF NOT EXISTS evelean.customer_info (
 ...
 customer_info_business_type ENUM('New Business','No Digital','Digital','Agency') NOT NULL,
 customer_info_industry ENUM('Industry 1','Industry 2','Industry 3','Industry 4','Industry 5') NOT NULL,
 customer_info_has_domain BOOLEAN NOT NULL,
 customer_info_facebook_ads_expenditure ENUM('No','0','5-200','200-2000','2000-10000','Over 10000') NOT NULL,
 customer_info_leadpages_target ENUM('Acquisition','Engagement','Sale','Other') NOT NULL,
